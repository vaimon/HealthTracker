...
object PreviewSampleData {
    val trainings = Resource.Success(
        sortedMapOf(
            LocalDate.of(2024, 3, 20) to TrainingDay(
                listOf(
                    Training(
            ...
            LocalDate.of(2024, 3, 19) to TrainingDay(
                listOf(
            ...
            LocalDate.of(2024, 3, 18) to TrainingDay(
                listOf()
            ),
            LocalDate.of(2024, 3, 17) to TrainingDay(
                listOf(
                    Training(5, LocalDateTime.now(), LocalDateTime.now(), listOf()),
                )
            ),
            LocalDate.of(2024, 3, 16) to TrainingDay(
                listOf(
            ...
            LocalDate.of(2024, 3, 13) to TrainingDay(
                listOf(
            ...
            LocalDate.of(2024, 3, 9) to TrainingDay(
                listOf()
            ),
            LocalDate.of(2024, 3, 8) to TrainingDay(
                listOf(
                    Training(26, LocalDateTime.now(), LocalDateTime.now(), listOf()),
                )
            ),
            LocalDate.of(2024, 3, 7) to TrainingDay(
                listOf(
                    Training(26, LocalDateTime.now(), LocalDateTime.now(), listOf()),
                    Training(27, LocalDateTime.now(), LocalDateTime.now(), listOf()),
                    Training(28, LocalDateTime.now(), LocalDateTime.now(), listOf()),
            ...
            LocalDate.of(2024, 3, 6) to TrainingDay(
                listOf(
                    Training(26, LocalDateTime.now(), LocalDateTime.now(), listOf()),
                    Training(27, LocalDateTime.now(), LocalDateTime.now(), listOf()),
                    Training(28, LocalDateTime.now(), LocalDateTime.now(), listOf()),
